...
function Player(props) {
    ...
    useEffect(() => {
        window.addEventListener("keydown", e => { listenerCheck(e, guardTalking, orcTalking, jaceTalking, thiefTalking, returnToWorldMap, enterShop, enterCastle) })
    }, [])
    ...
    function addListener(e, guardTalking, orcTalking, jaceTalking, thiefTalking, returnToWorldMap, enterShop, enterCastle) {
        ...
        handleKeyDown(e, guardTalking, orcTalking, jaceTalking, thiefTalking, returnToWorldMap, enterShop, enterCastle)
